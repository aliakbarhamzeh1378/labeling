...
import  sys
sys.path.append('/home/fjalili/LicensePlateRecognition/SamleCodes/keras-yolo2-master/')
...
FULL_YOLO_BACKEND_PATH  = "/home/fjalili/Downloads/full_yolo_backend.h5"   # should be hosted on a server
...
class FullYoloFeature(BaseFeatureExtractor):
    ...
    def __init__(self, input_sizeW,input_sizeH):
        input_image = Input(shape=(input_sizeH, input_sizeW, 3))
...
class Inception3Feature(BaseFeatureExtractor):
    ...
    def __init__(self, input_sizeW, input_sizeH):
        ...
        inception = InceptionV3(input_shape=(input_sizeW,input_sizeH,3), include_top=False)
...
class VGG16Feature(BaseFeatureExtractor):
    """docstring for ClassName"""
    def __init__(self, input_sizeW, input_sizeH):
        vgg16 = VGG16(input_shape=(input_sizeW, input_sizeH, 3), include_top=False)
...
class ResNet50Feature(BaseFeatureExtractor):
    """docstring for ClassName"""
    def __init__(self, input_sizeW, input_sizeH):
        resnet50 = ResNet50(input_shape=(input_sizeW, input_sizeH, 3), include_top=False)
